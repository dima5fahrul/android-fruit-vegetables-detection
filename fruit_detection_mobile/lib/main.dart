...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const _LiveDetection(),
    );
  }
}

class _LiveDetection extends StatefulWidget {
  const _LiveDetection({super.key});

  @override
  State<_LiveDetection> createState() => _LiveDetectionState();
}

class _LiveDetectionState extends State<_LiveDetection> {
  ...
  void initState() {
    ...
    controller.initialize().then((_) {
      ...
      controller.startImageStream((image) => {
            if (!isBusy) {isBusy = true, _imageLabeling(image)}
          });
